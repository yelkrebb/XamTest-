...
namespace Com.Qcl.VH.A.B {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.qcl.vh.a.b']/class[@name='庸']"
	[global::Android.Runtime.Register ("com/qcl/vh/a/b/庸", DoNotGenerateAcw=true)]
	public sealed partial class 庸 : global::Com.Qcl.VH.A.D.鷭, global::Com.Qcl.VH.A.D.IIF {

		// Metadata.xml XPath class reference: path="/api/package[@name='com.qcl.vh.a.b']/class[@name='庸.if']"
		[global::Android.Runtime.Register ("com/qcl/vh/a/b/庸$if", DoNotGenerateAcw=true)]
		public partial class If : global::Java.Lang.Object, global::Com.Qcl.VH.A.D.Ą.I鷭 {

			internal static IntPtr java_class_handle;
			internal static IntPtr class_ref {
				get {
					return JNIEnv.FindClass ("com/qcl/vh/a/b/庸$if", ref java_class_handle);
				}
			}
			...
			static IntPtr id_ctor_Lcom_qcl_vh_a_b_庸_;
			// Metadata.xml XPath constructor reference: path="/api/package[@name='com.qcl.vh.a.b']/class[@name='庸.if']/constructor[@name='庸.if' and count(parameter)=1 and parameter[1][@type='com.qcl.vh.a.b.庸']]"
			[Register (".ctor", "(Lcom/qcl/vh/a/b/庸;)V", "")]
			public unsafe If (global::Com.Qcl.VH.A.B.庸 __self)
				: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
			{
				...
				try {
					...
					if (id_ctor_Lcom_qcl_vh_a_b_庸_ == IntPtr.Zero)
						id_ctor_Lcom_qcl_vh_a_b_庸_ = JNIEnv.GetMethodID (class_ref, "<init>", "(Lcom/qcl/vh/a/b/庸;)V");
					SetHandle (
							global::Android.Runtime.JNIEnv.StartCreateInstance (class_ref, id_ctor_Lcom_qcl_vh_a_b_庸_, __args),
							JniHandleOwnership.TransferLocalRef);
					JNIEnv.FinishCreateInstance (Handle, class_ref, id_ctor_Lcom_qcl_vh_a_b_庸_, __args);
				} finally {
				}
			}
		...
		// Metadata.xml XPath class reference: path="/api/package[@name='com.qcl.vh.a.b']/class[@name='庸.鷭']"
		[global::Android.Runtime.Register ("com/qcl/vh/a/b/庸$鷭", DoNotGenerateAcw=true)]
		public partial class 鷭 : global::Java.Lang.Object, global::Com.Qcl.VH.A.D.Ą.I鷭 {

			internal static IntPtr java_class_handle;
			internal static IntPtr class_ref {
				get {
					return JNIEnv.FindClass ("com/qcl/vh/a/b/庸$鷭", ref java_class_handle);
				}
			}
			...
			// Metadata.xml XPath method reference: path="/api/package[@name='com.qcl.vh.a.b']/class[@name='庸.鷭']/method[@name='鷭' and count(parameter)=2 and parameter[1][@type='java.io.ByteArrayOutputStream'] and parameter[2][@type='java.lang.Object']]"
			...
			{
				鷭 (p0, global::Java.Interop.JavaObjectExtensions.JavaCast<global::Com.Qcl.VH.A.C.Ġ>(p1));
			}
		...
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/qcl/vh/a/b/庸", ref java_class_handle);
			}
		}
		...
		internal 庸 (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.qcl.vh.a.b']/class[@name='庸']/constructor[@name='庸' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe 庸 ()
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
