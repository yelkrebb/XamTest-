...
namespace Com.Qcl.VH.MD.And {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.qcl.vh.md.and']/class[@name='AndBpmGattClient']"
	[global::Android.Runtime.Register ("com/qcl/vh/md/and/AndBpmGattClient", DoNotGenerateAcw=true)]
	public partial class AndBpmGattClient : global::Com.Qcl.VH.MD.And.AndBaseGattClient {

		internal static new IntPtr java_class_handle;
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/qcl/vh/md/and/AndBpmGattClient", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (AndBpmGattClient); }
		}

		protected AndBpmGattClient (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.qcl.vh.md.and']/class[@name='AndBpmGattClient']/constructor[@name='AndBpmGattClient' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe AndBpmGattClient ()
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				if (GetType () != typeof (AndBpmGattClient)) {
					SetHandle (
		...
		static IntPtr id_ć;
		// Metadata.xml XPath method reference: path="/api/package[@name='com.qcl.vh.md.and']/class[@name='AndBpmGattClient']/method[@name='ć' and count(parameter)=0]"
		[Register ("ć", "()V", "")]
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.qcl.vh.md.and']/class[@name='AndBpmGattClient']/method[@name='ˮ͈' and count(parameter)=1 and parameter[1][@type='byte[]']]"
		...
		static IntPtr id_ˮ͍;
		// Metadata.xml XPath method reference: path="/api/package[@name='com.qcl.vh.md.and']/class[@name='AndBpmGattClient']/method[@name='ˮ͍' and count(parameter)=0]"
		[Register ("ˮ͍", "()V", "")]
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.qcl.vh.md.and']/class[@name='AndBpmGattClient']/method[@name='櫯' and count(parameter)=1 and parameter[1][@type='byte[]']]"
		[Register ("櫯", "([B)Z", "")]
		...
		static IntPtr id_鷭;
		// Metadata.xml XPath method reference: path="/api/package[@name='com.qcl.vh.md.and']/class[@name='AndBpmGattClient']/method[@name='鷭' and count(parameter)=0]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.qcl.vh.md.and']/class[@name='AndBpmGattClient']/method[@name='鷭' and count(parameter)=1 and parameter[1][@type='byte[]']]"
		[Register ("鷭", "([B)Z", "")]
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.qcl.vh.md.and']/class[@name='AndBpmGattClient']/method[@name='鷭' and count(parameter)=2 and parameter[1][@type='java.util.UUID'] and parameter[2][@type='byte[]']]"
