...
namespace Com.Qcl.VH.MD.And {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.qcl.vh.md.and']/class[@name='AndPbtCiDiscreteReadingsAdapter']"
	[global::Android.Runtime.Register ("com/qcl/vh/md/and/AndPbtCiDiscreteReadingsAdapter", DoNotGenerateAcw=true)]
	public partial class AndPbtCiDiscreteReadingsAdapter : global::Java.Lang.Object, global::Com.Qcl.VH.Content.IDeviceAdapter {

		internal static IntPtr java_class_handle;
		internal static IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/qcl/vh/md/and/AndPbtCiDiscreteReadingsAdapter", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (AndPbtCiDiscreteReadingsAdapter); }
		}

		protected AndPbtCiDiscreteReadingsAdapter (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.qcl.vh.md.and']/class[@name='AndPbtCiDiscreteReadingsAdapter']/constructor[@name='AndPbtCiDiscreteReadingsAdapter' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe AndPbtCiDiscreteReadingsAdapter ()
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				if (GetType () != typeof (AndPbtCiDiscreteReadingsAdapter)) {
					SetHandle (
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.qcl.vh.md.and']/class[@name='AndPbtCiDiscreteReadingsAdapter']/method[@name='ˮ͈' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.qcl.vh.md.and']/class[@name='AndPbtCiDiscreteReadingsAdapter']/method[@name='櫯' and count(parameter)=1 and parameter[1][@type='android.bluetooth.BluetoothSocket']]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.qcl.vh.md.and']/class[@name='AndPbtCiDiscreteReadingsAdapter']/method[@name='鷭' and count(parameter)=1 and parameter[1][@type='android.bluetooth.BluetoothSocket']]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.qcl.vh.md.and']/class[@name='AndPbtCiDiscreteReadingsAdapter']/method[@name='鷭' and count(parameter)=3 and parameter[1][@type='android.bluetooth.BluetoothSocket'] and parameter[2][@type='boolean'] and parameter[3][@type='boolean']]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.qcl.vh.md.and']/class[@name='AndPbtCiDiscreteReadingsAdapter']/method[@name='鷭' and count(parameter)=3 and parameter[1][@type='android.bluetooth.BluetoothSocket'] and parameter[2][@type='byte[]'] and parameter[3][@type='java.lang.String']]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.qcl.vh.md.and']/class[@name='AndPbtCiDiscreteReadingsAdapter']/method[@name='鷭' and count(parameter)=2 and parameter[1][@type='byte[]'] and parameter[2][@type='java.lang.String']]"
