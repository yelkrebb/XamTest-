...
namespace Com.Qcl.VH.MD.Fora {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.qcl.vh.md.fora']/class[@name='櫯']"
	[global::Android.Runtime.Register ("com/qcl/vh/md/fora/櫯", DoNotGenerateAcw=true)]
	public sealed partial class 櫯 : global::Java.Lang.Object, global::Com.Qcl.VH.MD.Fora.IIf {

		internal static IntPtr java_class_handle;
		internal static IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/qcl/vh/md/fora/櫯", ref java_class_handle);
			}
		}
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.qcl.vh.md.fora']/class[@name='櫯']/constructor[@name='櫯' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe 櫯 ()
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.qcl.vh.md.fora']/class[@name='櫯']/method[@name='鷭' and count(parameter)=4 and parameter[1][@type='int'] and parameter[2][@type='java.io.OutputStream'] and parameter[3][@type='java.io.InputStream'] and parameter[4][@type='int']]"
