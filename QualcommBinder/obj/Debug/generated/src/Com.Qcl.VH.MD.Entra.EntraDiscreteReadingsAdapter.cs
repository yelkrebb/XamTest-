...
namespace Com.Qcl.VH.MD.Entra {

	// Metadata.xml XPath class reference: path="/api/package[@name='com.qcl.vh.md.entra']/class[@name='EntraDiscreteReadingsAdapter']"
	[global::Android.Runtime.Register ("com/qcl/vh/md/entra/EntraDiscreteReadingsAdapter", DoNotGenerateAcw=true)]
	public partial class EntraDiscreteReadingsAdapter : global::Java.Lang.Object, global::Com.Qcl.VH.Content.IContextAwareAdapter, global::Com.Qcl.VH.Content.IDeviceAdapter {

		// Metadata.xml XPath class reference: path="/api/package[@name='com.qcl.vh.md.entra']/class[@name='EntraDiscreteReadingsAdapter.鷭']"
		[global::Android.Runtime.Register ("com/qcl/vh/md/entra/EntraDiscreteReadingsAdapter$鷭", DoNotGenerateAcw=true)]
		...
		internal static IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/qcl/vh/md/entra/EntraDiscreteReadingsAdapter", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (EntraDiscreteReadingsAdapter); }
		}

		protected EntraDiscreteReadingsAdapter (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.qcl.vh.md.entra']/class[@name='EntraDiscreteReadingsAdapter']/constructor[@name='EntraDiscreteReadingsAdapter' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe EntraDiscreteReadingsAdapter ()
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				if (GetType () != typeof (EntraDiscreteReadingsAdapter)) {
					SetHandle (
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.qcl.vh.md.entra']/class[@name='EntraDiscreteReadingsAdapter']/method[@name='ˮ͈' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.qcl.vh.md.entra']/class[@name='EntraDiscreteReadingsAdapter']/method[@name='櫯' and count(parameter)=1 and parameter[1][@type='android.bluetooth.BluetoothSocket']]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.qcl.vh.md.entra']/class[@name='EntraDiscreteReadingsAdapter']/method[@name='鷭' and count(parameter)=1 and parameter[1][@type='android.bluetooth.BluetoothSocket']]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.qcl.vh.md.entra']/class[@name='EntraDiscreteReadingsAdapter']/method[@name='鷭' and count(parameter)=3 and parameter[1][@type='android.bluetooth.BluetoothSocket'] and parameter[2][@type='boolean'] and parameter[3][@type='boolean']]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.qcl.vh.md.entra']/class[@name='EntraDiscreteReadingsAdapter']/method[@name='鷭' and count(parameter)=3 and parameter[1][@type='android.bluetooth.BluetoothSocket'] and parameter[2][@type='byte[]'] and parameter[3][@type='java.lang.String']]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.qcl.vh.md.entra']/class[@name='EntraDiscreteReadingsAdapter']/method[@name='鷭' and count(parameter)=1 and parameter[1][@type='android.content.Context']]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.qcl.vh.md.entra']/class[@name='EntraDiscreteReadingsAdapter']/method[@name='鷭' and count(parameter)=2 and parameter[1][@type='byte[]'] and parameter[2][@type='java.lang.String']]"
