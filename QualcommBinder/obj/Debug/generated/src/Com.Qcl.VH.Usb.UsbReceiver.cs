...
namespace Com.Qcl.VH.Usb {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.qcl.vh.usb']/class[@name='UsbReceiver']"
	[global::Android.Runtime.Register ("com/qcl/vh/usb/UsbReceiver", DoNotGenerateAcw=true)]
	public partial class UsbReceiver : global::Android.Content.BroadcastReceiver {

		internal static IntPtr java_class_handle;
		internal static IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/qcl/vh/usb/UsbReceiver", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (UsbReceiver); }
		}

		protected UsbReceiver (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.qcl.vh.usb']/class[@name='UsbReceiver']/constructor[@name='UsbReceiver' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe UsbReceiver ()
...
#pragma warning disable 0169
		...
		{
			global::Com.Qcl.VH.Usb.UsbReceiver __this = global::Java.Lang.Object.GetObject<global::Com.Qcl.VH.Usb.UsbReceiver> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.qcl.vh.usb']/class[@name='UsbReceiver']/method[@name='onReceive' and count(parameter)=2 and parameter[1][@type='android.content.Context'] and parameter[2][@type='android.content.Intent']]"
