...
namespace Com.Qcl.VH.A.B {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.qcl.vh.a.b']/class[@name='ˮ͍']"
	[global::Android.Runtime.Register ("com/qcl/vh/a/b/ˮ͍", DoNotGenerateAcw=true)]
	public sealed partial class ˮ͍ : global::Com.Qcl.VH.A.D.鷭, global::Com.Qcl.VH.A.D.IIF {

		// Metadata.xml XPath class reference: path="/api/package[@name='com.qcl.vh.a.b']/class[@name='ˮ͍.if']"
		[global::Android.Runtime.Register ("com/qcl/vh/a/b/ˮ͍$if", DoNotGenerateAcw=true)]
		public partial class If : global::Java.Lang.Object, global::Com.Qcl.VH.A.D.Ą.I鷭 {

			internal static IntPtr java_class_handle;
			internal static IntPtr class_ref {
				get {
					return JNIEnv.FindClass ("com/qcl/vh/a/b/ˮ͍$if", ref java_class_handle);
				}
			}
			...
			static IntPtr id_ctor_Lcom_qcl_vh_a_b_ˮ͍_;
			// Metadata.xml XPath constructor reference: path="/api/package[@name='com.qcl.vh.a.b']/class[@name='ˮ͍.if']/constructor[@name='ˮ͍.if' and count(parameter)=1 and parameter[1][@type='com.qcl.vh.a.b.ˮ͍']]"
			[Register (".ctor", "(Lcom/qcl/vh/a/b/ˮ͍;)V", "")]
			public unsafe If (global::Com.Qcl.VH.A.B.ˮ͍ __self)
				: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
			{
				...
				try {
					...
					if (id_ctor_Lcom_qcl_vh_a_b_ˮ͍_ == IntPtr.Zero)
						id_ctor_Lcom_qcl_vh_a_b_ˮ͍_ = JNIEnv.GetMethodID (class_ref, "<init>", "(Lcom/qcl/vh/a/b/ˮ͍;)V");
					SetHandle (
							global::Android.Runtime.JNIEnv.StartCreateInstance (class_ref, id_ctor_Lcom_qcl_vh_a_b_ˮ͍_, __args),
							JniHandleOwnership.TransferLocalRef);
					JNIEnv.FinishCreateInstance (Handle, class_ref, id_ctor_Lcom_qcl_vh_a_b_ˮ͍_, __args);
				} finally {
				}
			}
			...
			// Metadata.xml XPath method reference: path="/api/package[@name='com.qcl.vh.a.b']/class[@name='ˮ͍.if']/method[@name='櫯' and count(parameter)=1 and parameter[1][@type='byte[]']]"
			...
			public static unsafe string 櫯 (byte[] p0)
			{
				...
				try {
					...
					string __ret = JNIEnv.GetString (JNIEnv.CallStaticObjectMethod  (class_ref, id_櫯_arrayB, __args), JniHandleOwnership.TransferLocalRef);
					return __ret;
				} finally {
					if (p0 != null) {
			...
			// Metadata.xml XPath method reference: path="/api/package[@name='com.qcl.vh.a.b']/class[@name='ˮ͍.if']/method[@name='鷭' and count(parameter)=1 and parameter[1][@type='byte[]']]"
		...
		// Metadata.xml XPath class reference: path="/api/package[@name='com.qcl.vh.a.b']/class[@name='ˮ͍.鷭']"
		[global::Android.Runtime.Register ("com/qcl/vh/a/b/ˮ͍$鷭", DoNotGenerateAcw=true)]
		public partial class 鷭 : global::Java.Lang.Object, global::Com.Qcl.VH.A.D.Ą.I鷭 {

			internal static IntPtr java_class_handle;
			internal static IntPtr class_ref {
				get {
					return JNIEnv.FindClass ("com/qcl/vh/a/b/ˮ͍$鷭", ref java_class_handle);
				}
			}
			...
			// Metadata.xml XPath method reference: path="/api/package[@name='com.qcl.vh.a.b']/class[@name='ˮ͍.鷭']/method[@name='鷭' and count(parameter)=2 and parameter[1][@type='java.io.ByteArrayOutputStream'] and parameter[2][@type='java.lang.Object']]"
			...
			{
				鷭 (p0, global::Java.Interop.JavaObjectExtensions.JavaCast<global::Com.Qcl.VH.A.C.纫>(p1));
			}
		...
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/qcl/vh/a/b/ˮ͍", ref java_class_handle);
			}
		}
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.qcl.vh.a.b']/class[@name='ˮ͍']/constructor[@name='ˮ͍' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe ˮ͍ ()
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
