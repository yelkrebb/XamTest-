...
namespace Com.Qcl.VH.MD.Fora {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.qcl.vh.md.fora']/class[@name='ForaTestNGoBGMGattClient']"
	[global::Android.Runtime.Register ("com/qcl/vh/md/fora/ForaTestNGoBGMGattClient", DoNotGenerateAcw=true)]
	public partial class ForaTestNGoBGMGattClient : global::Com.Qcl.VH.MD.Fora.ForaGattClient {

		internal static new IntPtr java_class_handle;
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/qcl/vh/md/fora/ForaTestNGoBGMGattClient", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (ForaTestNGoBGMGattClient); }
		}

		protected ForaTestNGoBGMGattClient (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.qcl.vh.md.fora']/class[@name='ForaTestNGoBGMGattClient']/constructor[@name='ForaTestNGoBGMGattClient' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe ForaTestNGoBGMGattClient ()
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				if (GetType () != typeof (ForaTestNGoBGMGattClient)) {
					SetHandle (
		...
		static IntPtr id_ć;
		// Metadata.xml XPath method reference: path="/api/package[@name='com.qcl.vh.md.fora']/class[@name='ForaTestNGoBGMGattClient']/method[@name='ć' and count(parameter)=0]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.qcl.vh.md.fora']/class[@name='ForaTestNGoBGMGattClient']/method[@name='ȃ' and count(parameter)=1 and parameter[1][@type='byte[]']]"
		[Register ("ȃ", "([B)V", "")]
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.qcl.vh.md.fora']/class[@name='ForaTestNGoBGMGattClient']/method[@name='ˮ͈' and count(parameter)=1 and parameter[1][@type='byte[]']]"
		...
		static IntPtr id_鷭;
		// Metadata.xml XPath method reference: path="/api/package[@name='com.qcl.vh.md.fora']/class[@name='ForaTestNGoBGMGattClient']/method[@name='鷭' and count(parameter)=0]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.qcl.vh.md.fora']/class[@name='ForaTestNGoBGMGattClient']/method[@name='鷭' and count(parameter)=6 and parameter[1][@type='android.bluetooth.BluetoothGatt'] and parameter[2][@type='java.util.UUID'] and parameter[3][@type='byte[]'] and parameter[4][@type='int'] and parameter[5][@type='int'] and parameter[6][@type='java.util.List&lt;android.bluetooth.BluetoothGattDescriptor&gt;']]"
