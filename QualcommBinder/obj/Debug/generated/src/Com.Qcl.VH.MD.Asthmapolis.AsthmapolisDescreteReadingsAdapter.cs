...
namespace Com.Qcl.VH.MD.Asthmapolis {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.qcl.vh.md.asthmapolis']/class[@name='AsthmapolisDescreteReadingsAdapter']"
	[global::Android.Runtime.Register ("com/qcl/vh/md/asthmapolis/AsthmapolisDescreteReadingsAdapter", DoNotGenerateAcw=true)]
	public partial class AsthmapolisDescreteReadingsAdapter : global::Java.Lang.Object, global::Com.Qcl.VH.Content.IDeviceAdapter {

		internal static IntPtr java_class_handle;
		internal static IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/qcl/vh/md/asthmapolis/AsthmapolisDescreteReadingsAdapter", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (AsthmapolisDescreteReadingsAdapter); }
		}

		protected AsthmapolisDescreteReadingsAdapter (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.qcl.vh.md.asthmapolis']/class[@name='AsthmapolisDescreteReadingsAdapter']/constructor[@name='AsthmapolisDescreteReadingsAdapter' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe AsthmapolisDescreteReadingsAdapter ()
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				if (GetType () != typeof (AsthmapolisDescreteReadingsAdapter)) {
					SetHandle (
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.qcl.vh.md.asthmapolis']/class[@name='AsthmapolisDescreteReadingsAdapter']/method[@name='ˮ͈' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.qcl.vh.md.asthmapolis']/class[@name='AsthmapolisDescreteReadingsAdapter']/method[@name='櫯' and count(parameter)=1 and parameter[1][@type='android.bluetooth.BluetoothSocket']]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.qcl.vh.md.asthmapolis']/class[@name='AsthmapolisDescreteReadingsAdapter']/method[@name='鷭' and count(parameter)=1 and parameter[1][@type='android.bluetooth.BluetoothSocket']]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.qcl.vh.md.asthmapolis']/class[@name='AsthmapolisDescreteReadingsAdapter']/method[@name='鷭' and count(parameter)=3 and parameter[1][@type='android.bluetooth.BluetoothSocket'] and parameter[2][@type='boolean'] and parameter[3][@type='boolean']]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.qcl.vh.md.asthmapolis']/class[@name='AsthmapolisDescreteReadingsAdapter']/method[@name='鷭' and count(parameter)=3 and parameter[1][@type='android.bluetooth.BluetoothSocket'] and parameter[2][@type='byte[]'] and parameter[3][@type='java.lang.String']]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.qcl.vh.md.asthmapolis']/class[@name='AsthmapolisDescreteReadingsAdapter']/method[@name='鷭' and count(parameter)=2 and parameter[1][@type='byte[]'] and parameter[2][@type='java.lang.String']]"
