...
namespace Com.Qcl.VH.Receiver {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.qcl.vh.receiver']/class[@name='GenericBroadcastReceiver']"
	[global::Android.Runtime.Register ("com/qcl/vh/receiver/GenericBroadcastReceiver", DoNotGenerateAcw=true)]
	public partial class GenericBroadcastReceiver : global::Android.Content.BroadcastReceiver {

		internal static IntPtr java_class_handle;
		internal static IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/qcl/vh/receiver/GenericBroadcastReceiver", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (GenericBroadcastReceiver); }
		}

		protected GenericBroadcastReceiver (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.qcl.vh.receiver']/class[@name='GenericBroadcastReceiver']/constructor[@name='GenericBroadcastReceiver' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe GenericBroadcastReceiver ()
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				if (GetType () != typeof (GenericBroadcastReceiver)) {
					SetHandle (
...
#pragma warning disable 0169
		...
		{
			global::Com.Qcl.VH.Receiver.GenericBroadcastReceiver __this = global::Java.Lang.Object.GetObject<global::Com.Qcl.VH.Receiver.GenericBroadcastReceiver> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.qcl.vh.receiver']/class[@name='GenericBroadcastReceiver']/method[@name='onReceive' and count(parameter)=2 and parameter[1][@type='android.content.Context'] and parameter[2][@type='android.content.Intent']]"
