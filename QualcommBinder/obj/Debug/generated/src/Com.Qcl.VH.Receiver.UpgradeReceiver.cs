...
namespace Com.Qcl.VH.Receiver {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.qcl.vh.receiver']/class[@name='UpgradeReceiver']"
	[global::Android.Runtime.Register ("com/qcl/vh/receiver/UpgradeReceiver", DoNotGenerateAcw=true)]
	public partial class UpgradeReceiver : global::Android.Content.BroadcastReceiver {

		internal static IntPtr java_class_handle;
		internal static IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/qcl/vh/receiver/UpgradeReceiver", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (UpgradeReceiver); }
		}

		protected UpgradeReceiver (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.qcl.vh.receiver']/class[@name='UpgradeReceiver']/constructor[@name='UpgradeReceiver' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
			...
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				if (GetType () != typeof (UpgradeReceiver)) {
					SetHandle (
...
#pragma warning disable 0169
		...
		{
			global::Com.Qcl.VH.Receiver.UpgradeReceiver __this = global::Java.Lang.Object.GetObject<global::Com.Qcl.VH.Receiver.UpgradeReceiver> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.qcl.vh.receiver']/class[@name='UpgradeReceiver']/method[@name='onReceive' and count(parameter)=2 and parameter[1][@type='android.content.Context'] and parameter[2][@type='android.content.Intent']]"
