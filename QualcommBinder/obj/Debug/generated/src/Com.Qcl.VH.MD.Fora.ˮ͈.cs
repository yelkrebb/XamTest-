...
namespace Com.Qcl.VH.MD.Fora {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.qcl.vh.md.fora']/class[@name='ˮ͈']"
	[global::Android.Runtime.Register ("com/qcl/vh/md/fora/ˮ͈", DoNotGenerateAcw=true)]
	public sealed partial class ˮ͈ : global::Java.Lang.Object, global::Com.Qcl.VH.MD.Fora.IIf {

		internal static IntPtr java_class_handle;
		internal static IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/qcl/vh/md/fora/ˮ͈", ref java_class_handle);
			}
		}
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.qcl.vh.md.fora']/class[@name='ˮ͈']/constructor[@name='ˮ͈' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe ˮ͈ ()
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.qcl.vh.md.fora']/class[@name='ˮ͈']/method[@name='鷭' and count(parameter)=4 and parameter[1][@type='int'] and parameter[2][@type='java.io.OutputStream'] and parameter[3][@type='java.io.InputStream'] and parameter[4][@type='int']]"
