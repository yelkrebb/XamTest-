...
namespace Com.Qcl.VH.A.B {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.qcl.vh.a.b']/class[@name='ȃ']"
	[global::Android.Runtime.Register ("com/qcl/vh/a/b/ȃ", DoNotGenerateAcw=true)]
	public sealed partial class Ȃ : global::Com.Qcl.VH.A.D.鷭, global::Com.Qcl.VH.A.D.IIF {

		// Metadata.xml XPath class reference: path="/api/package[@name='com.qcl.vh.a.b']/class[@name='ȃ.if']"
		[global::Android.Runtime.Register ("com/qcl/vh/a/b/ȃ$if", DoNotGenerateAcw=true)]
		public partial class If : global::Java.Lang.Object, global::Com.Qcl.VH.A.D.Ą.I鷭 {

			internal static IntPtr java_class_handle;
			internal static IntPtr class_ref {
				get {
					return JNIEnv.FindClass ("com/qcl/vh/a/b/ȃ$if", ref java_class_handle);
				}
			}
			...
			static IntPtr id_ctor_Lcom_qcl_vh_a_b_ȃ_;
			// Metadata.xml XPath constructor reference: path="/api/package[@name='com.qcl.vh.a.b']/class[@name='ȃ.if']/constructor[@name='ȃ.if' and count(parameter)=1 and parameter[1][@type='com.qcl.vh.a.b.ȃ']]"
			[Register (".ctor", "(Lcom/qcl/vh/a/b/ȃ;)V", "")]
			public unsafe If (global::Com.Qcl.VH.A.B.Ȃ __self)
				: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
			{
				...
				try {
					...
					if (id_ctor_Lcom_qcl_vh_a_b_ȃ_ == IntPtr.Zero)
						id_ctor_Lcom_qcl_vh_a_b_ȃ_ = JNIEnv.GetMethodID (class_ref, "<init>", "(Lcom/qcl/vh/a/b/ȃ;)V");
					SetHandle (
							global::Android.Runtime.JNIEnv.StartCreateInstance (class_ref, id_ctor_Lcom_qcl_vh_a_b_ȃ_, __args),
							JniHandleOwnership.TransferLocalRef);
					JNIEnv.FinishCreateInstance (Handle, class_ref, id_ctor_Lcom_qcl_vh_a_b_ȃ_, __args);
				} finally {
				}
			}
			...
			// Metadata.xml XPath method reference: path="/api/package[@name='com.qcl.vh.a.b']/class[@name='ȃ.if']/method[@name='鷭' and count(parameter)=1 and parameter[1][@type='android.database.Cursor']]"
			[Register ("鷭", "(Landroid/database/Cursor;)Ljava/util/ArrayList;", "")]
		...
		// Metadata.xml XPath class reference: path="/api/package[@name='com.qcl.vh.a.b']/class[@name='ȃ.鷭']"
		[global::Android.Runtime.Register ("com/qcl/vh/a/b/ȃ$鷭", DoNotGenerateAcw=true)]
		public partial class 鷭 : global::Java.Lang.Object, global::Com.Qcl.VH.A.D.Ą.I鷭 {

			internal static IntPtr java_class_handle;
			internal static IntPtr class_ref {
				get {
					return JNIEnv.FindClass ("com/qcl/vh/a/b/ȃ$鷭", ref java_class_handle);
				}
			}
			...
			// Metadata.xml XPath method reference: path="/api/package[@name='com.qcl.vh.a.b']/class[@name='ȃ.鷭']/method[@name='鷭' and count(parameter)=2 and parameter[1][@type='java.io.ByteArrayOutputStream'] and parameter[2][@type='java.lang.Object']]"
			...
			{
				鷭 (p0, global::Java.Interop.JavaObjectExtensions.JavaCast<global::Com.Qcl.VH.A.C.Aux>(p1));
			}
		...
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/qcl/vh/a/b/ȃ", ref java_class_handle);
			}
		}
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.qcl.vh.a.b']/class[@name='ȃ']/constructor[@name='ȃ' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe Ȃ ()
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
