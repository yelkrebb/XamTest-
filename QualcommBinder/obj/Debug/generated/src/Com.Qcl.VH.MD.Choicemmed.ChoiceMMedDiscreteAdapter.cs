...
namespace Com.Qcl.VH.MD.Choicemmed {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.qcl.vh.md.choicemmed']/class[@name='ChoiceMMedDiscreteAdapter']"
	[global::Android.Runtime.Register ("com/qcl/vh/md/choicemmed/ChoiceMMedDiscreteAdapter", DoNotGenerateAcw=true)]
	public partial class ChoiceMMedDiscreteAdapter : global::Java.Lang.Object, global::Com.Qcl.VH.Content.IDeviceAdapter {

		internal static IntPtr java_class_handle;
		internal static IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/qcl/vh/md/choicemmed/ChoiceMMedDiscreteAdapter", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (ChoiceMMedDiscreteAdapter); }
		}

		protected ChoiceMMedDiscreteAdapter (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.qcl.vh.md.choicemmed']/class[@name='ChoiceMMedDiscreteAdapter']/constructor[@name='ChoiceMMedDiscreteAdapter' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe ChoiceMMedDiscreteAdapter ()
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				if (GetType () != typeof (ChoiceMMedDiscreteAdapter)) {
					SetHandle (
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.qcl.vh.md.choicemmed']/class[@name='ChoiceMMedDiscreteAdapter']/method[@name='ˮ͈' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.qcl.vh.md.choicemmed']/class[@name='ChoiceMMedDiscreteAdapter']/method[@name='櫯' and count(parameter)=1 and parameter[1][@type='android.bluetooth.BluetoothSocket']]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.qcl.vh.md.choicemmed']/class[@name='ChoiceMMedDiscreteAdapter']/method[@name='鷭' and count(parameter)=1 and parameter[1][@type='android.bluetooth.BluetoothSocket']]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.qcl.vh.md.choicemmed']/class[@name='ChoiceMMedDiscreteAdapter']/method[@name='鷭' and count(parameter)=3 and parameter[1][@type='android.bluetooth.BluetoothSocket'] and parameter[2][@type='boolean'] and parameter[3][@type='boolean']]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.qcl.vh.md.choicemmed']/class[@name='ChoiceMMedDiscreteAdapter']/method[@name='鷭' and count(parameter)=3 and parameter[1][@type='android.bluetooth.BluetoothSocket'] and parameter[2][@type='byte[]'] and parameter[3][@type='java.lang.String']]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.qcl.vh.md.choicemmed']/class[@name='ChoiceMMedDiscreteAdapter']/method[@name='鷭' and count(parameter)=2 and parameter[1][@type='byte[]'] and parameter[2][@type='java.lang.String']]"
