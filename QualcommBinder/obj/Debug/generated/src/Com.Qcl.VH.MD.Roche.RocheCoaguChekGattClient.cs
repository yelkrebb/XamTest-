...
namespace Com.Qcl.VH.MD.Roche {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.qcl.vh.md.roche']/class[@name='RocheCoaguChekGattClient']"
	[global::Android.Runtime.Register ("com/qcl/vh/md/roche/RocheCoaguChekGattClient", DoNotGenerateAcw=true)]
	public partial class RocheCoaguChekGattClient : global::Com.Qcl.VH.Ble.BaseGattClient, global::Com.Qcl.VH.Content.ICommandsAdapter {

		// Metadata.xml XPath class reference: path="/api/package[@name='com.qcl.vh.md.roche']/class[@name='RocheCoaguChekGattClient.鷭']"
		[global::Android.Runtime.Register ("com/qcl/vh/md/roche/RocheCoaguChekGattClient$鷭", DoNotGenerateAcw=true)]
		public new sealed partial class 鷭 : global::Java.Lang.Enum {


			static IntPtr ȃ_jfieldId;

			// Metadata.xml XPath field reference: path="/api/package[@name='com.qcl.vh.md.roche']/class[@name='RocheCoaguChekGattClient.鷭']/field[@name='ȃ']"
			[Register ("ȃ")]
			public static global::Com.Qcl.VH.MD.Roche.RocheCoaguChekGattClient.鷭 Ȃ {
				get {
					if (ȃ_jfieldId == IntPtr.Zero)
						ȃ_jfieldId = JNIEnv.GetStaticFieldID (class_ref, "ȃ", "Lcom/qcl/vh/md/roche/RocheCoaguChekGattClient$鷭;");
					IntPtr __ret = JNIEnv.GetStaticObjectField (class_ref, ȃ_jfieldId);
					return global::Java.Lang.Object.GetObject<global::Com.Qcl.VH.MD.Roche.RocheCoaguChekGattClient.鷭> (__ret, JniHandleOwnership.TransferLocalRef);
				}
			}

			static IntPtr ˮ͈_jfieldId;

			// Metadata.xml XPath field reference: path="/api/package[@name='com.qcl.vh.md.roche']/class[@name='RocheCoaguChekGattClient.鷭']/field[@name='ˮ͈']"
			[Register ("ˮ͈")]
			public static global::Com.Qcl.VH.MD.Roche.RocheCoaguChekGattClient.鷭 ˮ͈ {
				get {
					if (ˮ͈_jfieldId == IntPtr.Zero)
						ˮ͈_jfieldId = JNIEnv.GetStaticFieldID (class_ref, "ˮ͈", "Lcom/qcl/vh/md/roche/RocheCoaguChekGattClient$鷭;");
			...
			// Metadata.xml XPath field reference: path="/api/package[@name='com.qcl.vh.md.roche']/class[@name='RocheCoaguChekGattClient.鷭']/field[@name='櫯']"
			[Register ("櫯")]
			public static global::Com.Qcl.VH.MD.Roche.RocheCoaguChekGattClient.鷭 櫯 {
				get {
					if (櫯_jfieldId == IntPtr.Zero)
						櫯_jfieldId = JNIEnv.GetStaticFieldID (class_ref, "櫯", "Lcom/qcl/vh/md/roche/RocheCoaguChekGattClient$鷭;");
			...
			// Metadata.xml XPath field reference: path="/api/package[@name='com.qcl.vh.md.roche']/class[@name='RocheCoaguChekGattClient.鷭']/field[@name='鷭']"
			[Register ("鷭")]
			public static global::Com.Qcl.VH.MD.Roche.RocheCoaguChekGattClient.鷭 鷭 {
				get {
					if (鷭_jfieldId == IntPtr.Zero)
						鷭_jfieldId = JNIEnv.GetStaticFieldID (class_ref, "鷭", "Lcom/qcl/vh/md/roche/RocheCoaguChekGattClient$鷭;");
			...
			internal static IntPtr class_ref {
				get {
					return JNIEnv.FindClass ("com/qcl/vh/md/roche/RocheCoaguChekGattClient$鷭", ref java_class_handle);
				}
			}
		...
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/qcl/vh/md/roche/RocheCoaguChekGattClient", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (RocheCoaguChekGattClient); }
		}

		protected RocheCoaguChekGattClient (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.qcl.vh.md.roche']/class[@name='RocheCoaguChekGattClient']/constructor[@name='RocheCoaguChekGattClient' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe RocheCoaguChekGattClient ()
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				if (GetType () != typeof (RocheCoaguChekGattClient)) {
					SetHandle (
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.qcl.vh.md.roche']/class[@name='RocheCoaguChekGattClient']/method[@name='ˮ͈' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.qcl.vh.md.roche']/class[@name='RocheCoaguChekGattClient']/method[@name='櫯' and count(parameter)=1 and parameter[1][@type='byte[]']]"
		[Register ("櫯", "([B)Z", "")]
		...
		static IntPtr id_鷭;
		// Metadata.xml XPath method reference: path="/api/package[@name='com.qcl.vh.md.roche']/class[@name='RocheCoaguChekGattClient']/method[@name='鷭' and count(parameter)=0]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.qcl.vh.md.roche']/class[@name='RocheCoaguChekGattClient']/method[@name='鷭' and count(parameter)=1 and parameter[1][@type='android.bluetooth.BluetoothGatt']]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.qcl.vh.md.roche']/class[@name='RocheCoaguChekGattClient']/method[@name='鷭' and count(parameter)=3 and parameter[1][@type='android.bluetooth.BluetoothGatt'] and parameter[2][@type='int'] and parameter[3][@type='int']]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.qcl.vh.md.roche']/class[@name='RocheCoaguChekGattClient']/method[@name='鷭' and count(parameter)=6 and parameter[1][@type='android.bluetooth.BluetoothGatt'] and parameter[2][@type='java.util.UUID'] and parameter[3][@type='byte[]'] and parameter[4][@type='int'] and parameter[5][@type='int'] and parameter[6][@type='java.util.List&lt;android.bluetooth.BluetoothGattDescriptor&gt;']]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.qcl.vh.md.roche']/class[@name='RocheCoaguChekGattClient']/method[@name='鷭' and count(parameter)=6 and parameter[1][@type='android.bluetooth.BluetoothGatt'] and parameter[2][@type='java.util.UUID'] and parameter[3][@type='byte[]'] and parameter[4][@type='int'] and parameter[5][@type='java.util.UUID'] and parameter[6][@type='int']]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.qcl.vh.md.roche']/class[@name='RocheCoaguChekGattClient']/method[@name='鷭' and count(parameter)=3 and parameter[1][@type='android.bluetooth.BluetoothSocket'] and parameter[2][@type='byte[]'] and parameter[3][@type='java.lang.String']]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.qcl.vh.md.roche']/class[@name='RocheCoaguChekGattClient']/method[@name='鷭' and count(parameter)=1 and parameter[1][@type='byte[]']]"
		[Register ("鷭", "([B)Z", "")]
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.qcl.vh.md.roche']/class[@name='RocheCoaguChekGattClient']/method[@name='鷭' and count(parameter)=2 and parameter[1][@type='byte[]'] and parameter[2][@type='java.lang.String']]"
