...
namespace Com.Qcl.VH.Receiver {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.qcl.vh.receiver']/class[@name='UpgradeReceiverLegacy']"
	[global::Android.Runtime.Register ("com/qcl/vh/receiver/UpgradeReceiverLegacy", DoNotGenerateAcw=true)]
	public partial class UpgradeReceiverLegacy : global::Android.Content.BroadcastReceiver {

		internal static IntPtr java_class_handle;
		internal static IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/qcl/vh/receiver/UpgradeReceiverLegacy", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (UpgradeReceiverLegacy); }
		}

		protected UpgradeReceiverLegacy (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.qcl.vh.receiver']/class[@name='UpgradeReceiverLegacy']/constructor[@name='UpgradeReceiverLegacy' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe UpgradeReceiverLegacy ()
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				if (GetType () != typeof (UpgradeReceiverLegacy)) {
					SetHandle (
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.qcl.vh.receiver']/class[@name='UpgradeReceiverLegacy']/method[@name='onReceive' and count(parameter)=2 and parameter[1][@type='android.content.Context'] and parameter[2][@type='android.content.Intent']]"
