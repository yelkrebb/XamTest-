...
namespace Com.Qcl.VH.MD.Choicemmed {

	// Metadata.xml XPath class reference: path="/api/package[@name='com.qcl.vh.md.choicemmed']/class[@name='ChoiceMMedGattClient']"
	[global::Android.Runtime.Register ("com/qcl/vh/md/choicemmed/ChoiceMMedGattClient", DoNotGenerateAcw=true)]
	public partial class ChoiceMMedGattClient : global::Com.Qcl.VH.Ble.BaseGattClient {

		// Metadata.xml XPath class reference: path="/api/package[@name='com.qcl.vh.md.choicemmed']/class[@name='ChoiceMMedGattClient.鷭']"
		[global::Android.Runtime.Register ("com/qcl/vh/md/choicemmed/ChoiceMMedGattClient$鷭", DoNotGenerateAcw=true)]
		public new partial class 鷭 : global::Java.Lang.Object, global::Java.Lang.IRunnable {

			internal static IntPtr java_class_handle;
			internal static IntPtr class_ref {
				get {
					return JNIEnv.FindClass ("com/qcl/vh/md/choicemmed/ChoiceMMedGattClient$鷭", ref java_class_handle);
				}
			}
			...
			static IntPtr id_ctor_Lcom_qcl_vh_md_choicemmed_ChoiceMMedGattClient_Landroid_bluetooth_BluetoothGatt_;
			// Metadata.xml XPath constructor reference: path="/api/package[@name='com.qcl.vh.md.choicemmed']/class[@name='ChoiceMMedGattClient.鷭']/constructor[@name='ChoiceMMedGattClient.鷭' and count(parameter)=2 and parameter[1][@type='com.qcl.vh.md.choicemmed.ChoiceMMedGattClient'] and parameter[2][@type='android.bluetooth.BluetoothGatt']]"
			[Register (".ctor", "(Lcom/qcl/vh/md/choicemmed/ChoiceMMedGattClient;Landroid/bluetooth/BluetoothGatt;)V", "")]
			public unsafe 鷭 (global::Com.Qcl.VH.MD.Choicemmed.ChoiceMMedGattClient __self, global::Android.Bluetooth.BluetoothGatt p1)
				: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
			{
				...
				try {
					...
					if (id_ctor_Lcom_qcl_vh_md_choicemmed_ChoiceMMedGattClient_Landroid_bluetooth_BluetoothGatt_ == IntPtr.Zero)
						id_ctor_Lcom_qcl_vh_md_choicemmed_ChoiceMMedGattClient_Landroid_bluetooth_BluetoothGatt_ = JNIEnv.GetMethodID (class_ref, "<init>", "(Lcom/qcl/vh/md/choicemmed/ChoiceMMedGattClient;Landroid/bluetooth/BluetoothGatt;)V");
					SetHandle (
							global::Android.Runtime.JNIEnv.StartCreateInstance (class_ref, id_ctor_Lcom_qcl_vh_md_choicemmed_ChoiceMMedGattClient_Landroid_bluetooth_BluetoothGatt_, __args),
							JniHandleOwnership.TransferLocalRef);
					JNIEnv.FinishCreateInstance (Handle, class_ref, id_ctor_Lcom_qcl_vh_md_choicemmed_ChoiceMMedGattClient_Landroid_bluetooth_BluetoothGatt_, __args);
				} finally {
				}
			}

			static IntPtr id_run;
			// Metadata.xml XPath method reference: path="/api/package[@name='com.qcl.vh.md.choicemmed']/class[@name='ChoiceMMedGattClient.鷭']/method[@name='run' and count(parameter)=0]"
			[Register ("run", "()V", "")]
		...
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/qcl/vh/md/choicemmed/ChoiceMMedGattClient", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (ChoiceMMedGattClient); }
		}

		protected ChoiceMMedGattClient (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.qcl.vh.md.choicemmed']/class[@name='ChoiceMMedGattClient']/constructor[@name='ChoiceMMedGattClient' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe ChoiceMMedGattClient ()
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (Handle != IntPtr.Zero)
				return;
			...
			try {
				if (GetType () != typeof (ChoiceMMedGattClient)) {
					SetHandle (
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.qcl.vh.md.choicemmed']/class[@name='ChoiceMMedGattClient']/method[@name='櫯' and count(parameter)=1 and parameter[1][@type='byte[]']]"
		[Register ("櫯", "([B)Z", "")]
		...
		static IntPtr id_鷭;
		// Metadata.xml XPath method reference: path="/api/package[@name='com.qcl.vh.md.choicemmed']/class[@name='ChoiceMMedGattClient']/method[@name='鷭' and count(parameter)=0]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.qcl.vh.md.choicemmed']/class[@name='ChoiceMMedGattClient']/method[@name='鷭' and count(parameter)=1 and parameter[1][@type='android.bluetooth.BluetoothGatt']]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.qcl.vh.md.choicemmed']/class[@name='ChoiceMMedGattClient']/method[@name='鷭' and count(parameter)=3 and parameter[1][@type='android.bluetooth.BluetoothGatt'] and parameter[2][@type='int'] and parameter[3][@type='int']]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.qcl.vh.md.choicemmed']/class[@name='ChoiceMMedGattClient']/method[@name='鷭' and count(parameter)=1 and parameter[1][@type='byte[]']]"
		[Register ("鷭", "([B)Z", "")]
