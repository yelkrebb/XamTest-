...
namespace Com.Qcl.VH.A.B {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.qcl.vh.a.b']/class[@name='ą']"
	[global::Android.Runtime.Register ("com/qcl/vh/a/b/ą", DoNotGenerateAcw=true)]
	public sealed partial class Ą : global::Com.Qcl.VH.A.D.鷭, global::Com.Qcl.VH.A.D.IIF {

		// Metadata.xml XPath class reference: path="/api/package[@name='com.qcl.vh.a.b']/class[@name='ą.if']"
		[global::Android.Runtime.Register ("com/qcl/vh/a/b/ą$if", DoNotGenerateAcw=true)]
		public partial class If : global::Java.Lang.Object, global::Com.Qcl.VH.A.D.Ą.I鷭 {

			internal static IntPtr java_class_handle;
			internal static IntPtr class_ref {
				get {
					return JNIEnv.FindClass ("com/qcl/vh/a/b/ą$if", ref java_class_handle);
				}
			}
			...
			static IntPtr id_ctor_Lcom_qcl_vh_a_b_ą_;
			// Metadata.xml XPath constructor reference: path="/api/package[@name='com.qcl.vh.a.b']/class[@name='ą.if']/constructor[@name='ą.if' and count(parameter)=1 and parameter[1][@type='com.qcl.vh.a.b.ą']]"
			[Register (".ctor", "(Lcom/qcl/vh/a/b/ą;)V", "")]
			public unsafe If (global::Com.Qcl.VH.A.B.Ą __self)
				: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
			{
				...
				try {
					...
					if (id_ctor_Lcom_qcl_vh_a_b_ą_ == IntPtr.Zero)
						id_ctor_Lcom_qcl_vh_a_b_ą_ = JNIEnv.GetMethodID (class_ref, "<init>", "(Lcom/qcl/vh/a/b/ą;)V");
					SetHandle (
							global::Android.Runtime.JNIEnv.StartCreateInstance (class_ref, id_ctor_Lcom_qcl_vh_a_b_ą_, __args),
							JniHandleOwnership.TransferLocalRef);
					JNIEnv.FinishCreateInstance (Handle, class_ref, id_ctor_Lcom_qcl_vh_a_b_ą_, __args);
				} finally {
				}
			}
			...
			// Metadata.xml XPath method reference: path="/api/package[@name='com.qcl.vh.a.b']/class[@name='ą.if']/method[@name='鷭' and count(parameter)=2 and parameter[1][@type='byte[]'] and parameter[2][@type='int']]"
			[Register ("鷭", "([BI)I", "")]
		...
		// Metadata.xml XPath class reference: path="/api/package[@name='com.qcl.vh.a.b']/class[@name='ą.鷭']"
		[global::Android.Runtime.Register ("com/qcl/vh/a/b/ą$鷭", DoNotGenerateAcw=true)]
		public partial class 鷭 : global::Java.Lang.Object, global::Com.Qcl.VH.A.D.Ą.I鷭 {

			internal static IntPtr java_class_handle;
			internal static IntPtr class_ref {
				get {
					return JNIEnv.FindClass ("com/qcl/vh/a/b/ą$鷭", ref java_class_handle);
				}
			}
			...
			// Metadata.xml XPath method reference: path="/api/package[@name='com.qcl.vh.a.b']/class[@name='ą.鷭']/method[@name='鷭' and count(parameter)=2 and parameter[1][@type='java.io.ByteArrayOutputStream'] and parameter[2][@type='java.lang.Object']]"
		...
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/qcl/vh/a/b/ą", ref java_class_handle);
			}
		}
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.qcl.vh.a.b']/class[@name='ą']/constructor[@name='ą' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe Ą ()
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
